...
public class ChangePasswordForm {
	...
	@NotBlank(message="Necesita introducir una contraseña")
	...
	public String toString() {
		return "CambiarPasswor [id=" + id + ", currentPassword=" + currentPassword + ", newPassword=" + newPassword
